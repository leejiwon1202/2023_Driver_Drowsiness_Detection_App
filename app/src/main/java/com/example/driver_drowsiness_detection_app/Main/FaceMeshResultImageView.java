...
public class FaceMeshResultImageView extends AppCompatImageView {
  ...
  private void drawLandmarksOnCanvas(Canvas canvas, List<NormalizedLandmark> faceLandmarkList,
      ImmutableSet<FaceMeshConnections.Connection> connections, Size imageSize, int color, int thickness) {
    // Draw connections.
